...
public class BluetoothLeService extends Service {
    ...
    public BluetoothGattService getBluetoothGaatServiceInstance(){
            return new BluetoothGattService(UUID.fromString(mBluetoothDeviceAddress), BluetoothGattService.SERVICE_TYPE_PRIMARY);
        }
